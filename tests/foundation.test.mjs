...
test('required foundation assets exist and are nonempty', () => {
  const required = [
    ...
    'package.json', 'package-lock.json', 'docs/architecture.md', 'docs/requirements.md',
    'docs/workflow.md', 'docs/workflow-model.json', 'docs/development.md',
    'docs/agent-execution.md', 'docs/originals/manifest.json',
